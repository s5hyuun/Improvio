...
CREATE TABLE `dislike` (
  ...
  UNIQUE KEY `unique_dislike` (`user_id`,`suggestion_id`),
  KEY `user_id` (`user_id`),
  KEY `suggestion_id` (`suggestion_id`),
  CONSTRAINT `dislike_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE,
  CONSTRAINT `dislike_ibfk_2` FOREIGN KEY (`suggestion_id`) REFERENCES `suggestion` (`suggestion_id`) ON DELETE CASCADE
...
INSERT INTO `dislike` VALUES (1,1,2,'2025-09-24 06:57:09'),(2,1,5,'2025-09-24 07:00:37'),(3,1,10,'2025-09-24 07:02:18'),(4,1,7,'2025-09-24 07:02:29'),(5,1,1,'2025-09-24 07:02:58'),(6,1,3,'2025-09-24 07:03:01'),(7,1,9,'2025-09-24 07:03:04'),(8,1,12,'2025-09-24 07:03:48'),(9,1,8,'2025-09-24 07:05:01');
...
CREATE TABLE `vote` (
  ...
  UNIQUE KEY `unique_user_vote` (`user_id`,`suggestion_id`),
  KEY `suggestion_id` (`suggestion_id`),
...
INSERT INTO `vote` VALUES (8,1,1,1,'2025-09-23 07:52:27'),(14,1,2,1,'2025-09-24 06:57:10'),(16,1,5,1,'2025-09-24 07:00:36'),(18,1,3,1,'2025-09-24 07:01:51'),(19,1,10,1,'2025-09-24 07:02:18'),(20,1,7,1,'2025-09-24 07:02:28'),(26,1,9,1,'2025-09-24 07:03:03'),(27,1,12,1,'2025-09-24 07:03:48'),(29,1,8,1,'2025-09-24 07:05:01');
...
-- Dump completed on 2025-09-24 16:21:39
