...
export default function Manager() {
  ...
  const stats = [
    { label: t("manager.stats.totalEmployees"), value: 5 },
    { label: t("manager.stats.totalSuggestions"), value: 3 },
    { label: t("manager.stats.activeNotices"), value: 2 },
    { label: t("manager.stats.urgentSuggestions"), value: 1 },
  ];
        ...
        <section className="content">
          ...
          <div className={styles.btn}>
            ...
            >
              ...
              {t("manager.menu.notice")}
            </button>
          </div>

          {active === "dashboard" && (
            <div style={gridStyle} aria-label={t("manager.dashboardLabel")}>
              {stats.map((s, i) => (
