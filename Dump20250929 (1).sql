...
INSERT INTO `post` VALUES (1,1,1,'첫 번째 자유게시판 글','안녕하세요! 첫 번째 글입니다 ?','approved','2025-09-24 20:27:50',1),(2,1,2,'React 질문 있습니다','React에서 useEffect와 useState 차이가 궁금합니다.','approved','2025-09-24 20:27:50',2),(3,2,3,'신입게시판 인사드립니다','안녕하세요. 이번에 새로 들어온 박지훈입니다. 잘 부탁드립니다 ?','approved','2025-09-24 20:27:50',5),(4,4,2,'정보 공유: MySQL 팁','JOIN 최적화하는 방법을 정리했습니다.','approved','2025-09-24 20:27:50',2),(5,6,1,'? 시사/이슈 - AI 뉴스','최근 AI 관련 큰 이슈가 있어 공유드립니다.','approved','2025-09-24 20:27:50',1),(6,5,1,'ww','ww','pending','2025-09-29 06:01:31',5);
...
INSERT INTO `postattachment` VALUES (1,6,'/uploads/1759125691810-641929496.jpg','2025-09-29 06:01:31');
...
-- Dump completed on 2025-09-29 15:38:17
