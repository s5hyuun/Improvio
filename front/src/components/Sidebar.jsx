...
export default function Sidebar() {
  ...
  const departments = [
    ...
    { id: "globalSales", label: t("sidebar.departments.globalSales"), icon: "globe" },
    { id: "basicDesign", label: t("sidebar.departments.basicDesign"), icon: "doc" },
    { id: "futureBiz", label: t("sidebar.departments.futureBiz"), icon: "flag" },
    { id: "shipDesign", label: t("sidebar.departments.shipDesign"), icon: "triangle" },
    { id: "marineDesign", label: t("sidebar.departments.marineDesign"), icon: "sea" },
  ...
  const displayName = showAnonProfile ? t("sidebar.loginPrompt") : (auth?.username || t("sidebar.username"));
  ...
  const profileDeptLabel = deptLabelFromAuth || deptLabelFromLocal || t("sidebar.noDept");
    ...
    <aside className="sidebar">
      <div className="sidebar-inner">
        ...
        <section className="profile">
          ...
          {!showAnonProfile && (
            <>
              <button className="link-btn" type="button">{t("sidebar.edit")}</button>
              <div className="chip-row">
                <span className="chip chip-primary">{profileDeptLabel}</span>
                {isAdmin && <span className="chip chip-warn">{t("sidebar.admin")}</span>}
              </div>
            </>
          )}
        </section>
